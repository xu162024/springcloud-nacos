...
1. 克隆代码库： `git clone https://github.com/xu162024/springcloud-nacos.git`
...
* 1.启动基础服务：前提需要安装docker-compose 进入docker-compose目录，执行`docker-compose -f docker-compose.yml up` 或单个启动`docker-compose up 服务名`, 服务名如下
...
|  服务           |   服务名         |  端口     | 备注                                            |
|----------------|-----------------|-----------|-------------------------------------------------|
|  数据库         |   mysql(5.7最好)         |  3306     |  目前各应用共用1个实例，各应用可建不同的database     |
